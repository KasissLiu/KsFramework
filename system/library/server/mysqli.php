...
class server_mysqli
{
 ...
 // Create the empty 0 index
     ...
     * @param int $port            
     */
    public function __construct($host = NULL, $user = NULL, $passwd = NULL, $dbname = NULL, $port = NULL, $charset = 'utf8')
    {
        $isSubQuery = false;
     ...
     * 
     * @param
     *            int increment by int or float. 1 by default
     */
    ...
    {
        return new Server_mysqli(Array(
            'host' => $subQueryAlias,
            'isSubQuery' => true
        ));
    }
     ...
     *            
     * @return s boolean True if table exists
     */
